declare module 'thinky' {
	...
	class R {
		...
		db(name: string): Db
		table<
			UDocument extends connect.Document<any, any, any>,
			UAttributes
		>(
			name: string,
	...
	interface ItemSequence<UDocument>
		extends Operation<UDocument>,
			Writeable {
		// Join
		...
		//thinky join
		// getJoin<JoinedUDocument extends connect.Document<any, any, any>>(
		// 	modelToGet: connect.Model<any, any, any>
		...
		concatMap(
			transform: ExpressionFunction<any>
		): ItemSequence<UDocument>
	...
	class Thinky {
		...
		createModel<
			UDocument extends connect.Document<any, any, any>,
			UModel extends connect.Model<any, any, any>,
